...
namespace OctoWatcher
{
    ...
    public partial class Form2
    {
        ...
        {
            string json_string = "";
            json_string = getJSONstring(MainForm.url + "/api/version");
        ...
        public conn getConnection()
        {
            ...
            string json_string = getJSONstring(MainForm.url + "/api/connection");
        ...
        public printer getPrinter()
        {
            ...
            string json_string = getJSONstring(MainForm.url + "/api/printer");
        ...
        public jobMain getJob()
        {
            ...
            string json_string = getJSONstring(MainForm.url + "/api/job");
        ...
        {
            WebRequest request = WebRequest.Create(octoPiIP);
            request.ContentType = "application/json";
            request.Headers.Add("X-Api-key: " + MainForm.api);
            request.Proxy = null;
            request.Method = "GET";
